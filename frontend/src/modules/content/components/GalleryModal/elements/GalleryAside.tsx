...
import ModalSendFeedback from '@/modules/content/components/ModalSendFeedback/ModalSendFeedback';
...
type Props = {
  ...
  resetFlag: boolean;
  onOriginalImageClick: (clicked: boolean) => void;
};

export const GalleryAside: FC<Props> = ({
  contentItem,
  isVideoContent,
  onValidatePicture,
  resetFlag,
  ...
  return (
    <aside className="h-full w-1/4 px-8 pt-9">
      ...
      <div className={cx('flex flex-col gap-2', !isVideoContent && 'pt-10')}>
        <QualityFeedback
          resetFlag={resetFlag}
          onValidatePicture={onValidatePicture}
          isModalOpen={isModalOpen}
          vehicleItem={contentItem}
        />
